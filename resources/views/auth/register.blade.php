                ...
                @csrf
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg" name="email" type="text" value="{{old('email')}}" placeholder="Enter your email">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-lg" name="mobile" type="text" value="{{old('mobile')}}" placeholder="Enter your mobile">
