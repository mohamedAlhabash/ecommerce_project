            ...
            <div class="container px-0 px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0">
                    <a class="navbar-brand" href="{{ route('boutique.index') }}">
                        <span class="font-weight-bold text-uppercase text-dark">{{config('app.name')}}</span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <!-- Link--><a class="nav-link {{ request()->routeIs('boutique.index') ? 'active' : '' }}"
                                    href="{{ route('boutique.index') }}">Home</a>
                            </li>
                            <li class="nav-item">
                                <!-- Link--><a class="nav-link {{ request()->routeIs('boutique.shop') ? 'active' : '' }}"
                                    href="{{ route('boutique.shop') }}">Shop</a>
                            </li>
                            <li class="nav-item">
                                <!-- Link--><a class="nav-link {{ request()->routeIs('boutique.detail') ? 'active' : '' }}"
                                    href="{{ route('boutique.detail') }}">Product detail</a>
                            </li>
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown"
                                ...
                                <div class="dropdown-menu mt-3" aria-labelledby="pagesDropdown">
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('boutique.index') }}">Homepage</a>
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('boutique.shop') }}">Category</a>
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('boutique.detail') }}">Product
                                        detail</a>
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('boutique.cart') }}">Shopping
                                        cart</a>
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{ route('boutique.checkout') }}">Checkout</a>
                                </div>
                            </li>
                        </ul>
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"><a class="nav-link" href="{{ route('boutique.cart') }}"> <i
                            ...
                            @else
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="{{ route('logout') }}"> <i
                                class="fas fa-user-alt mr-1 text-gray"></i>Logout</a></li>
                            @endguest
                            {{-- @auth
                                    else guest the simmilar of auth
                                    auth that used to if the customer login then the route of logout appear
                            @endauth --}}
                        </ul>
                    </div>
                </nav>
                            ...
                            <div class="p-5 my-md-4">
                                ...
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div class="col-sm-5 pl-sm-0"><a
                                            ...
                                            href="{{ route('boutique.cart') }}">Add to cart</a></div>
                                </div>
